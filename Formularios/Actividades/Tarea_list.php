  ...
  <div class="container">
    <div class="table-responsive">
      ...
      <table class="table table-condensed table-bordered table-hover">
        ...
        <thead>
        <tr >        
          <th bgcolor="#D8D8D8">HORA</th>
          <th bgcolor="#D8D8D8">INICIO</th>
          <th bgcolor="#D8D8D8">FIN</th>
          <th bgcolor="#D8D8D8">ASIGNATURA</th>
          <th bgcolor="#D8D8D8">CURSO</th>
          <th bgcolor="#D8D8D8">DESCRIPCIÓN</th>
          <th bgcolor="#D8D8D8">No. ALUMNOS</th>
          <th bgcolor="#D8D8D8">OBSERVACIONES</th>
        ...
        foreach ($TareaCollectorObj->showTarea() as $c) {
          echo '<tbody>
              		<tr>
            			...
            			<td>' . $c->getfecha_entrega() . '</td>
            			<td>14</td>  
            			  <td><a href="Tarea_edit.php?id=' . $c->getcod_Tarea() . '">Actualizar <i class="fa fa-pencil-square-o" ></i></a></td>                		
                		<td><a href="#">Finalizar <i class="fa fa-check-square-o"></i></a></td>

...
<section id="contact-page">
  <div class="container">
    ...
    <div class="row contact-wrap">
      ...
      <form action="Sesion_insert.php" method="post" action="form-horizontal">
        <div class="col-sm-5 col-sm-offset-1">
          ...
          <div class="form-group">
            ...
            <input type="text" name="pasw" class="form-control" required="required">
          </div>
        </div>
        <div class="form-group">
  ...
  <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <div class="widget">
          <h3><a href="#">Actividades acad̩micas</a></h3>
        </div>
      </div><!--/.col-md-3-->
      <div class="col-md-3 col-sm-6">
        <div class="widget">
          <h3><a href="#">Calendario acad̩mico</a></h3>
        </div>
      </div><!--/.col-md-3-->
      <div class="col-md-3 col-sm-6">
        <div class="widget">

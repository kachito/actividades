...
<div class="table-responsive"> 
    <table class="table table-condensed table-bordered table-hover">
        <thead>
            <tr>
                  ...
                  <th bgcolor="#D8D8D8">DIRIGENCIA</th>
  ...
  <tr>
     ...
     <td><?php echo $c->getdirigencia() ?></td>
     <td><?php echo $c->getcargo() ?></td>
     <td><?php echo $c->getemail() ?></td>
   
     <td><a href="form_docente.php">Nuevo</a></td>   
     <td><a href="Docente_edit.php?id=<?php echo $c->getid_profesor() ?>">Editar</a></td>
     <td><a href="Docente_delete.php?id=<?php echo $c->getid_profesor() ?>">Eliminar</a></td>
  </tr>
  </tbody> 
  <?php  
  }

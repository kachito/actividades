    ...
    <div class="row contact-wrap">
      ...
      <form action="Docente_update.php" method="post" action="form-horizontal">
        <div class="col-sm-8 col-sm-offset-4">
          ...
          <input type="number" name="id_profesor" required="required" style="visibility:hidden" readonly
                 value="<?php echo $ObjDocente->getid_profesor(); ?>">
        </div>
        ...
        <div class="col-sm-5">
          ...
          <div class="form-group">
            ...
            <input type="text" name="dirigencia" class="form-control" required="required"
                   value="<?php echo $ObjDocente->getdirigencia(); ?>">
          </div>
          <div class="form-group">
            <label>Cargo*</label>
            <input type="text" name="cargo" class="form-control" required="required"
                   value="<?php echo $ObjDocente->getcargo(); ?>">
          </div>
          <div class="form-group">
            <label>Email *</label>
            <input type="email" name="email" class="form-control" required="required"
                   value="<?php echo $ObjDocente->getemail(); ?>">

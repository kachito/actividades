      ...
      <div class="row contact-wrap">
        ...
        <form action="Tarea_update.php" method="post" action="form-horizontal">
          ...
          <div class="col-sm-5 col-sm-offset-1">
            ...
            <label>Curso: *</label>
            <input type="text" disabled class="form-control" name="curso" id="curso"
                   value=" <?php
                   echo $ObjTarea->getdescripcion();
                   ?>">
          </div>

            <div class="form-group">
              <label>Materia a dictar: *</label>
              <input type="text" name="materia" disabled  class="form-control"
                     value=" <?php
                     echo $ObjTarea->getdescripcion_mat();
                     ?>">
            </div>
